...
def main():
    ...
    desktop_parser = subparsers.add_parser(
        name="desktop",
        description="Send a desktop notification before and after function "
    ...
    discord_parser = subparsers.add_parser(
        name="discord",
        description="Send a Discord message before and after function "
    ...
    email_parser = subparsers.add_parser(
        name="email",
        description="Send an email before and after function "
        + "execution, with start and end status (sucessfully or crashed).",
    )
    ...
    slack_parser = subparsers.add_parser(
        name="slack",
        description="Send a Slack message before and after function "
        + "execution, with start and end status (sucessfully or crashed).",
    )
    ...
    telegram_parser = subparsers.add_parser(
        name="telegram",
        description="Send a Telegram message before and after "
    ...
    teams_parser = subparsers.add_parser(
        name="teams",
        description="Send a teams message before and after function "
        + "execution, with start and end status (sucessfully or crashed).",
    )
    ...
    wechat_parser = subparsers.add_parser(
        name="wechat",
        description="Send a WeChat Work message before and after function "
        + "execution, with start and end status (sucessfully or crashed).",
    )
    ...
    def run_func():
        return subprocess.run(remaining_args, check=True)
